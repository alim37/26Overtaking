...
setup(
    ...
    entry_points={
        "console_scripts": [
            ...
            "ethz_all_data_logger = autodrive_f1tenth.ethz_all_data_logger:main",
            ...
            "forza_opponent_tracker = autodrive_f1tenth.forza_opponent_tracker:main",
            ...
            "predictive_spliner_decision = autodrive_f1tenth.predictive_spliner_decision:main",
            "confidence_roc_decision = autodrive_f1tenth.confidence_roc_decision:main",
            "engagement_zones = autodrive_f1tenth.engagement_zones:main",
            "engagement_zones_dynamic = autodrive_f1tenth.engagement_zones_dynamic:main",
            "engagement_zone_controller = autodrive_f1tenth.engagement_zone_controller:main",
            "follow_stack = autodrive_f1tenth.follow_stack:main",
            "plot_pure_pursuit_runs = autodrive_f1tenth.plot_pure_pursuit_runs:main",
            "plot_ethz_all_data = autodrive_f1tenth.plot_ethz_all_data:main",
